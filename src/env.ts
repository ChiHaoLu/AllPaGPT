...
export const defaultEnv = {
  ...
  CLIENT_DEFAULT_MESSAGE: `Powered by [OpenAI Vercel](https://github.com/ourongxing/chatgpt-vercel)
- ***Author: [ChiHaoLu](https://chihaolu.me)([chihaolu.eth](https://chihaolu.eth.xyz)) @ imToken Labs***
- ***使用此服務代表你熟知以下事項：***
