      ...
      <Switch>
        <Match when={actionState.showSetting === "global"}>
          <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
            ...
            <SettingItem icon="i-carbon:keyboard" label="Enter 鍵發送訊息">
              <SwitchButton
        ...
        <Match when={actionState.showSetting === "session"}>
          <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
            ...
            <SettingItem icon="i-carbon:save-image" label="記錄對話內容">
              <SwitchButton
          ...
          fallback={
            <div class="flex">
              ...
              <ActionItem
                ...
                label={actionState.clearSessionConfirm ? "確定" : "清空對話"}
              />
            </div>
          }
        >
            ...
            <div class="flex">
              ...
              <Show when={store.sessionId !== "index"}>
                ...
                <ActionItem
                  ...
                  label={actionState.deleteSessionConfirm ? "確定" : "刪除對話"}
                />
              </Show>
            </div>
          </Match>
